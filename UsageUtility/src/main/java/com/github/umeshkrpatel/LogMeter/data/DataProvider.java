...
public final class DataProvider extends ContentProvider {
    ...
    static {
        ...
        URI_MATCHER.addURI(kAuthority, "logs", LOGS);
        URI_MATCHER.addURI(kAuthority, "logs/#", LOGS_ID);
        URI_MATCHER.addURI(kAuthority, "logs/sum", LOGS_SUM);
        URI_MATCHER.addURI(kAuthority, "logs/join", LOGS_JOIN);
        URI_MATCHER.addURI(kAuthority, "plans", PLANS);
        URI_MATCHER.addURI(kAuthority, "plans/#", PLANS_ID);
        URI_MATCHER.addURI(kAuthority, "plans/sum", PLANS_SUM);
        URI_MATCHER.addURI(kAuthority, "plans/sum/#", PLANS_SUM_ID);
        URI_MATCHER.addURI(kAuthority, "rules", RULES);
        URI_MATCHER.addURI(kAuthority, "rules/#", RULES_ID);
        URI_MATCHER.addURI(kAuthority, "numbers", NUMBERS);
        URI_MATCHER.addURI(kAuthority, "numbers/#", NUMBERS_ID);
        URI_MATCHER.addURI(kAuthority, "numbers/group/#", NUMBERS_GID);
        URI_MATCHER.addURI(kAuthority, "numbers/groups/", NUMBERS_GROUP);
        URI_MATCHER.addURI(kAuthority, "numbers/groups/#", NUMBERS_GROUP_ID);
        URI_MATCHER.addURI(kAuthority, "hours", HOURS);
        URI_MATCHER.addURI(kAuthority, "hours/#", HOURS_ID);
        URI_MATCHER.addURI(kAuthority, "hours/group/#", HOURS_GID);
        URI_MATCHER.addURI(kAuthority, "hours/groups/", HOURS_GROUP);
        URI_MATCHER.addURI(kAuthority, "hours/groups/#", HOURS_GROUP_ID);
        URI_MATCHER.addURI(kAuthority, "websms", WEBSMS);
        URI_MATCHER.addURI(kAuthority, "sipcall", SIPCALL);
    }
    ...
    public static final class Logs {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/logs");
        /**
         * Content {@link Uri} logs joined with plans and rules.
         */
        public static final Uri CONTENT_URI_JOIN = Uri.parse("content://" + kAuthority
                + "/logs/join");
        /**
         * Content {@link Uri} - sum.
         */
        public static final Uri SUM_URI = Uri.parse("content://" + kAuthority + "/logs/sum");
        /**
    ...
    public static final class WebSMS {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/websms");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class SipCall {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/sipcall");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class Plans {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/plans");
        /**
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI_SUM = Uri
                .parse("content://" + kAuthority + "/plans/sum");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class Rules {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/rules");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class Numbers {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/numbers");
        /**
         * Content {@link Uri} for a group of numbers.
         */
        public static final Uri GROUP_URI = Uri.parse("content://" + kAuthority + "/numbers/group");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class NumbersGroup {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority
                + "/numbers/groups");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class Hours {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/hours");
        /**
         * Content {@link Uri} for a group of numbers.
         */
        public static final Uri GROUP_URI = Uri.parse("content://" + kAuthority + "/hours/group");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
    ...
    public static final class HoursGroup {
         ...
         * Content {@link Uri}.
         */
        public static final Uri CONTENT_URI = Uri.parse("content://" + kAuthority + "/hours/groups");
        /**
         * The MIME type of {@link #CONTENT_URI} providing a list.
         */
